---
title: "Analysis Report 2: The SPP1 Gene Showing Higher Expression Counts in Lung Cancer Related Traits"
...
joined_table %>%
  ...
  ggplot(aes(x = genename,
             ...
             fill = cancer_stage)) +
    geom_col(position = "dodge") +
  ggtitle("Mean Expression Counts of SPP1 in Different Cancer Stages")
```
...
joined_table %>%
  ...
  ggplot(aes(x = genename,
             ...
             fill = smoking_status)) +
    geom_col(position = "dodge") +
  ggtitle("Mean Expression Counts of SPP1 With Different Smoking Statuses")
```
...
# used to look at these two specific sections of the large
# dataset. The summarize function was used to obtain the mean
# expression count values. Different ages of diagnosis will give
# us an idea about how different ages may express expression
# of SPP1. Older ages may lead to higher expression since
# this gene has to deal with lung cancer.
joined_table %>%
  filter(genename == "SPP1") %>%
  ...
  ggplot(aes(x = age_at_diagnosis,
             ...
             fill = genename)) +
    geom_col(position = "dodge") +
  ggtitle("Mean Expression Counts of SPP1 With Different Ages at Diagnosis")
```
